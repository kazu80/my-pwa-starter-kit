...
// Slice reducer: it only reduces the bit of state it's concerned about.
    ...
    switch (action.type) {
        ...
        case REMOVE_FROM_CART:
            ...
            if (quantityById[productId] <= 1) {
                // This removes all item in this array equal to productId.
...
// Per Redux best practices, the shop data in our store in structured
